...
#es_host = '10.24.0.7'
#es_port = os.getenv('10.24.0.7', 9200) #amundsen default es port, override env variable with target ip
#
#neo_host = '10.24.0.7'
#neo_port = os.getenv('10.24.0.7', 7687) #amundsen default neo4j db server port, override env variable with target ip
